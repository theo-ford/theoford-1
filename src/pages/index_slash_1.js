...
import { TwoUpProjectCarouselSwiperSlash1 } from "../components/tf/index/two-up-carousels/two-up-carousel-swiper-slash-1";
import { OneUpProjectCarouselSwiperSlash1 } from "../components/tf/index/one-up-carousel/one-up-carousel-swiper-slash-1";
    ...
    (content, index) => {
      ...
      if (content.project_relationship_field.document.type == "project") {
        ...
        if (isPageWide && projectLength > 1) {
          return (
            <ProjectCon>
              <TwoUpProjectCarouselSwiperSlash1
                projectLength={
                  content.project_relationship_field.document.data.body.length
                }
              >
          ...
          return (
            <ProjectCon>
              <OneUpProjectCarouselSwiperSlash1 projectLength={projectLength}>
                {React.Children.map(project, child =>
                  React.cloneElement(child, {
                    changedSlide: false,
                  })
                )}
              </OneUpProjectCarouselSwiperSlash1>
              <ProjectInfo2
                data2={content.project_relationship_field.document.data}
                uid={content.project_relationship_field.document.uid}
              ></ProjectInfo2>
