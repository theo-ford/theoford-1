...
const Index = ({ data }) => {
  ...
  //     // console.log("documentBodyScrollTop" + documentBodyScrollTop);

  //     var indexRefYOffset = indexRef.current.pageYOffset;
  //     console.log("indexRefYOffset" + indexRefYOffset);
  //     // setScrollPosition(y);
  ...
  // indexRef.addEventListener("scroll", handleScroll);
  // useEffect(() => {
  ...
  return (
    <>
      ...
      {/* <NavSpacer></NavSpacer>
      <LogoGridCon>
        <LogoCon ref={LogoConRef} className={scrollPosition ? "" : "shrink"}>
          <Icon />
        </LogoCon>
        <NavCon1>
          <p className="selected">Selected</p>
