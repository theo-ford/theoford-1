 ...
 */
export declare const asLinkAttrs: <LinkResolverFunctionReturnType = string | null | undefined, Field extends LinkField | PrismicDocument<Record<string, any>, string, string> | null | undefined = LinkField | PrismicDocument<Record<string, any>, string, string> | null | undefined>(linkFieldOrDocument: Field, config?: AsLinkAttrsConfig<LinkResolverFunctionReturnType, LinkField | PrismicDocument<Record<string, any>, string, string> | null | undefined>) => {
    href?: undefined;
    target?: undefined;
    rel?: undefined;
} | {
