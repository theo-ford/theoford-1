...
const index = require("../../eventemitter3/index.cjs");
const index$1 = require("../../p-timeout/index.cjs");
    ...
    return new Promise((resolve, reject) => {
      __classPrivateFieldGet(this, _PQueue_queue, "f").enqueue(async () => {
        ...
        try {
          ...
          if (options.timeout) {
            operation = index$1.default(Promise.resolve(operation), options.timeout);
          }
          if (options.signal) {
          ...
          if (error instanceof index$1.TimeoutError && !options.throwOnTimeout) {
            resolve();
            return;
          }
          reject(error);
