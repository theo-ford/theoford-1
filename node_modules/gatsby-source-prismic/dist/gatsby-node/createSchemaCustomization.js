import { asLink, isFilled, asText, asHTML, LinkType } from "@prismicio/client";
import { buildImageObjectType } from "../lib/buildImageObjectType.js";
import { buildImgixURLParamsInputObjectType } from "../lib/buildImgixURLParamsInputObjectType.js";
import { customTypeModelToGraphQLType } from "../lib/customTypeModelToGraphQLType.js";
import { getModelsCacheKey } from "../lib/getModelsCacheKey.js";
import { pascalCase } from "../lib/pascalCase.js";
import { resolveModels } from "../lib/resolveModels.js";
import { sharedSliceModelToGraphQLType } from "../lib/sharedSliceModelToGraphQLType.js";
import { GatsbyImageDataPlaceholderKind } from "../constants.js";
const createSchemaCustomization = async (args, options) => {
  const { customTypeModels, sharedSliceModels } = await resolveModels({
    pluginOptions: options
  });
  args.cache.set(getModelsCacheKey({ repositoryName: options.repositoryName }), {
    customTypeModels,
    sharedSliceModels
  });
  let customTypeTypes = [];
    ...
    args.schema.buildObjectType({
      ...
      fields: {
        ...
        document: {
          ...
          resolve: (source) => {
            if (isFilled.link(source) && source.link_type === LinkType.Document && !source.isBroken) {
              return args.createNodeId(source.id);
            } else {
              return null;
            }
